...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault(); // Создаем блок с сообщениями
      ...
      statusMessage.appendChild(textMessage); // Собираем все данные из этой Формы

      var formData = new FormData(item);
      var api;
      item.closest('.popup-design') || item.classList.contains('calc_form') ? api = path.designer : api = path.question;
      console.log(api); // Отправляем запрос на сервер c данными formData
...
var modals = function modals() {
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      ...
      if (!display) {
        document.querySelector(selector).style.display = 'block'; // document.body.style.overflow = "hidden";

        var scroll = calcScroll(); // document.body.style.marginRight = `${scroll}px`;
      }
    }, time);
  }
...
var scrolling = function scrolling(upSelector) {
  var upElem = document.querySelector(upSelector); // Scroll 1650px
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    // getResouce('http://localhost:3000/styles')
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResouce"])('assets/db.json').then(function (res) {
...
/*!*************************************!*\
  !*** ./src/js/services/requests.js ***!
  \*************************************/
/*! exports provided: postData, getResouce */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "postData", function() { return postData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getResouce", function() { return getResouce; });
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat */ "./node_modules/core-js/modules/es.array.concat.js");
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.object.to-string */ "./node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1__);
...
var getResouce = function getResouce(url) {
  var res;
  return regeneratorRuntime.async(function getResouce$(_context2) {
    while (1) {
